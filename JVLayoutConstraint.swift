                ...
                case .changed:
                    existingConstraint.constant = constant;
                        ...
                        if  debugConstraints.equalsTrue{
                            ...
                            debugger.log("✏️ Constraint changed \(nearestCommonAncestor.className)\(extraIdentifierString):")
                            debugger.log(self)
                        }
            ...
            if constraintComparison != .changed{
                nearestCommonAncestor.addConstraint(self)
                    ...
                    if  debugConstraints.equalsTrue{
                        ...
                        debugger.log("✅ Constraint added to \(nearestCommonAncestor.className)\(extraIdentifierString):")
                        debugger.log(self)
                    }
        ...
        if let nearestCommonAncestor = firstView.nearestCommonAncestor(withView: secondView) {
            ...
            nearestCommonAncestor.removeConstraint(self)
                ...
                if  debugConstraints.equalsTrue{
                    ...
                    debugger.log("❌ Constraint removed from \(nearestCommonAncestor.className)\(extraIdentifierString):")
                    debugger.log(self)
                }
